...
<div class="content-wrapper">
	<div class="container-fluid">
		<section class="content-header">
			<h3>District <small>all</small></h3>
			<ol class="breadcrumb">
			...
			<div class="col-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title"><i class="fa fa-credit-card mr-1"></i> {{ __('All Districts') }}</h3>
						...
						<table id="dataTables" class="display nowrap" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									<td>{{ $district->id }}</td>
									<td>{{ $district->name }}</td>
									<td><a href="{{ route('districts.edit', $district->id) }}" class="btn btn-success fa fa-edit"></a></td>
									<td><a href="{{ route('districts.destroy', $district->id) }}" onclick="event.preventDefault(); document.getElementById('delete-form').action = this.href; document.getElementById('delete-form').submit.click();" class="btn btn-danger fa fa-trash"></button></td>
								</tr>
								@endforeach
							</tbody>
							<tfoot>
