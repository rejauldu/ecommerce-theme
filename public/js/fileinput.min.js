...
!function (e) {
    ...
    b.prototype = {
        constructor: b, init: function (e) {
            ...
            return e.mainTemplate.replace(/\{class\}/g, e.mainClass).replace(/\{preview\}/g, i).replace(/\{caption\}/g, n).replace(/\{upload\}/g, e.renderRemove()).replace(/\{browse\}/g, e.renderBrowse())
